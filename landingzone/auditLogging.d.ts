...
export declare class AuditLogging extends pulumi.ComponentResource {
     ...
     */
    readonly cloudWatchDashboard: pulumi.Output<pulumiAws.cloudwatch.Dashboard | undefined>;
    /**
     * The CloudWatch Log Group used to store the data.
     */
    readonly cloudWatchLogGroup: pulumi.Output<pulumiAws.cloudwatch.LogGroup | undefined>;
    /**
     * The IAM Policy used by the IAM Role for Cloud Trail.
     */
    readonly cloudWatchPolicy: pulumi.Output<pulumiAws.iam.Policy | undefined>;
    /**
     * The IAM Role used by Cloud Trail to write to CloudWatch..
     */
    readonly cloudWatchRole: pulumi.Output<pulumiAws.iam.Role | undefined>;
    /**
     * The IAM Role Policy Attachments that attach the IAM Role with the IAM Policy.
     */
    readonly cloudWatchRolePolicyAttachment: pulumi.Output<pulumiAws.iam.RolePolicyAttachment | undefined>;
    /**
