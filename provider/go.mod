module github.com/cloud-toolkit-aws/cloud-toolkit-aws/provider

go 1.18

replace github.com/pulumi/pulumi/pkg/v3 v3.48.0 => github.com/astrokube/pulumi/pkg/v3 v3.0.0-20221128081625-a43c61153639
