...
export class AwsLoadBalancerController extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'cloud-toolkit-aws:kubernetes:AwsLoadBalancerController';
     ...
     */
    public static isInstance(obj: any): obj is AwsLoadBalancerController {
