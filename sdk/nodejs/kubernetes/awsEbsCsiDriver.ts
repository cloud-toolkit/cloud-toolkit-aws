...
export class AwsEbsCsiDriver extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'cloud-toolkit-aws:kubernetes:AwsEbsCsiDriver';

    /**
     * Returns true if the given object is an instance of AwsEbsCsiDriver.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AwsEbsCsiDriver {
